...
function Fighter(game, theCarrier) {
	//console.log("fighter for team " + theCarrier.TeamNumber + " created.");
...
Fighter.prototype.selectAction = function () {
...
Fighter.prototype.collideLeft = function () {
    return (this.x - this.radius) < this.game.sides.left;
};

Fighter.prototype.collideRight = function () {
    return (this.x + this.radius) > this.game.sides.right;
};

Fighter.prototype.collideTop = function () {
    return (this.y - this.radius) < this.game.sides.top;
};

Fighter.prototype.collideBottom = function () {
